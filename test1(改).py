   ...
   # 循環開始！ 
    while running:
        ...
        if selectCharacter:
            ...
            blit_alpha(screen, imagePlayers['機械'], (250, 100), button_alpha)
            blit_alpha(screen, imagePlayers['土木'], (250, 200), button_alpha)
            blit_alpha(screen, imagePlayers['國企'], (250, 300), button_alpha)
            blit_alpha(screen, imagePlayers['會計'], (250, 400), button_alpha)
            blit_alpha(screen, imagePlayers['經濟'], (250, 500), button_alpha)
            blit_alpha(screen, imagePlayers['醫學'], (500, 100), button_alpha)
            blit_alpha(screen, imagePlayers['哲學'], (500, 200), button_alpha)
            blit_alpha(screen, imagePlayers['中文'], (500, 300), button_alpha)
            blit_alpha(screen, imagePlayers['生科'], (500, 400), button_alpha)
            blit_alpha(screen, imagePlayers['法律'], (500, 500), button_alpha)
