   ...
   # 循環開始！ 
    while running:
        ...
        if selectCharacter:				 
            ...
            blit_alpha(screen, ce_rect , (100, 500), 255)
            blit_alpha(screen, me_rect, (200, 500), 255)
            blit_alpha(screen, ib_rect , (300, 500), 255)
            blit_alpha(screen, acct_rect , (400, 500), 255)
            blit_alpha(screen, econ_rect , (500, 500), 255)
            blit_alpha(screen, med_rect , (600, 500), 255)
            blit_alpha(screen, phy_rect , (700, 500), 255)
            blit_alpha(screen, chi_rect , (800, 500), 255)
            blit_alpha(screen, bio_rect , (900, 500), 255)
            blit_alpha(screen, law_rect , (1000, 500), 255)
