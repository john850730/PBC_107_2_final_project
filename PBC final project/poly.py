...
def main():
	...
	green = (0,255,0)
    blue = (0,0,255)
    #font = py,game.font.Font('''''''')
    
    
    # 上傳圖片
    # 基本
    backgroud = pygame.image.load("resource\\pic\\GameMap.png")
    chessPlayer1 = pygame.image.load("resource\\pic\\chess1.png")
    chessPlayer2 =  pygame.image.load("resource\\pic\\chess2.png")
	chessPlayer3 =  pygame.image.load("resource\\pic\\chess3.png")
	chessPlayer4 =  pygame.image.load("resource\\pic\\chess4.png")
	...
	SelectCharacter = pygame.image.load("resource\\pic\\SelectCharacter.png")
	
    turnover = pygame.image.load("resource\\pic\\turnover.png")
    turnover2 = pygame.image.load("resource\\pic\\turnover2.png")
    
    #玩家圖檔Image TBD
    imagePlayer0 = pygame.image.load("resource\\pic\\ce.png").convert_alpha()
    imagePlayer1 = pygame.image.load("resource\\pic\\me.png").convert_alpha()
    imagePlayer2 = pygame.image.load("resource\\pic\\ib.png").convert_alpha()
    imagePlayer3 = pygame.image.load("resource\\pic\\acct.png").convert_alpha()
    imagePlayer4 = pygame.image.load("resource\\pic\\econ.png").convert_alpha()
    imagePlayer5 = pygame.image.load("resource\\pic\\med.png").convert_alpha()
    imagePlayer6 = pygame.image.load("resource\\pic\\phy.png").convert_alpha()
    imagePlayer7 = pygame.image.load("resource\\pic\\chi.png").convert_alpha()
    imagePlayer8 = pygame.image.load("resource\\pic\\bio.png").convert_alpha()
